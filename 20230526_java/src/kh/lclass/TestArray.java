...
//		for(int i = 0; i<strArr.length-1; i++) {
		...
		// System.out.println(strArr[3]); >> // IndexOutOfBoundsException 발생함
	
		int[] intArr = new int[3];
		System.out.println(intArr[1]);
		
		int[] intArr2 = new int [] {1,2,3}; //이렇게 외워야함 앞으로 나오는 2차열 배열때문에 이렇게 사용해야함
		int[] intArr3 = {1,2,3};
		
		// Student[] studentArr = new 
	}
	//	int[][] arr = {1,2,3,4},{5,6,7,8} >> int[2][4]
}
