...
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '김행복','010-1111-2222', '서울 동대문구 휘경1동',TO_DATE('20151202', 'YYYYMMDD'), 'VIP', '01');
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '이춘복', '010-1111-3333', '서울 동대문구 휘경2동', TO_DATE('20151206', 'YYYYMMDD'), '일반', '01');
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '장믿음', '010-1111-4444', '울릉군 울릉읍 독도1리', TO_DATE('20151001', 'YYYYMMDD'), '일반', '30');
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '최사랑', '010-1111-5555', '울릉군 울릉읍 독도2리', TO_DATE('20151113', 'YYYYMMDD'), 'VIP', '30');
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '진평화', '010-1111-6666', '제주도 제주시 외나무골', TO_DATE('20151225', 'YYYYMMDD'), '일반', '60');
INSERT INTO CUSTOMER_INFO ( CUSTNO, CUSTNAME, PHONE, ADDRESS, JOINDATE, GRADE, CITY) VALUES(seq_no.nextval, '차공단', '010-1111-7777', '제주도 제주시 감나무골', TO_DATE('20151211', 'YYYYMMDD'), '직원', '60');   
